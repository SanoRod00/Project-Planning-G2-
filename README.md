...
| Test | Screenshot |
|---|---|
| Tables created (`SHOW TABLES`) | `docs/database/screenshots/01-tables-created.png` |
| Constraints registered (`information_schema.TABLE_CONSTRAINTS`) | `docs/database/screenshots/02-constraints-list.png` |
| CHECK constraint rejection | `docs/database/screenshots/03-check-constraint-fail.png` |
| FOREIGN KEY constraint rejection | `docs/database/screenshots/04-foreign-key-fail.png` |
| Valid insert + select | `docs/database/screenshots/05-valid-insert.png` |
